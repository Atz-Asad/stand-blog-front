<?php
  ...
  $stm = $pdo->prepare("SELECT * FROM managepost");
  $stm->execute();
  $managepostList=$stm->fetchAll(PDO::FETCH_ASSOC);

  // echo ("<pre>");
  // print_r ($managepostLis);
  // echo ("</pre>");
          ...
          <div class="item">
            ...
            <div class="item-content">
              <div class="main-content">
                <div class="meta-category">
                  <span>asad</span>
                  <span><?php echo $admin['topic'] ;?></span>
                </div>
          ...
          <div class="col-lg-8">
            <div class="all-blog-posts">
              <div class="row">
                ...
                <?php
                foreach ($managepostList as $manage) :?>
                <div class="col-lg-12 ">
                  
                  <div class="blog-post">
                    <div class="blog-thumb">
                      <img src="../admin/<?php echo $manage['photo'];?>" alt="">
                    </div>
                    <div class="down-content">
                      
                      <span><?php echo $manage['topic'];?></span>

                      <a href="post-details.php?id=<?php echo $manage['id']?>"><h4><?php echo $manage['title'];?></h4></a>
                      <ul class="post-info">
                        <li><a href="#">Admin</a></li>                  
                        <li><a href="#"><?php echo $manage['created_at'];?></a></li>
                        <li><a href="#">12 Comments</a></li>
                      </ul>
                      <p><?php echo $manage['about'];?></p>
